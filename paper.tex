...
The full v2 corpus comprises 149 cell-collections across 9 labs, with $\sim 10{,}000$ valid freeflow samples and a parallel values-probe collection at $n{=}120$ per cell, shared across this paper and the two companion papers, and released as a citable dataset on Zenodo \citep{tenner2026corpus}. For the routing-and-provider question, the relevant subset is:
...
\midrule
\emph{MiniMax M2}   &  6 & 0.76    & ${<}10^{-6}$  & 4 & 3 \\
...
\newblock \emph{Zenodo}, 2026-05.
\newblock Concept DOI: \href{https://doi.org/10.5281/zenodo.20013518}{10.5281/zenodo.20013518}.
